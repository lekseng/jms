...
echo -e "  Auther : ${green}JMS STORE ® ${NC}${YELLOW}(${NC} ${green} JMS TUNNELING ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/lekseng/jms/master/"
