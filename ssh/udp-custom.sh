...
wget -q -O /etc/udp/udp-custom "https://raw.githubusercontent.com/scisaa/jms/master/ssh/udp-custom-linux-amd64"
chmod +x /etc/udp/udp-custom
echo downloading default config
wget -q -O /etc/udp/config.json "https://raw.githubusercontent.com/scisaa/jms/master/ssh/config.json"
